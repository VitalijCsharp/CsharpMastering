...
namespace GraphDemo
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void plotButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Task first = Task.Run(() => generateGraphData(data, 0, pixelWidth / 4, cancellationToken), cancellationToken);
            Task second = Task.Run(() => generateGraphData(data, pixelWidth / 4, pixelWidth / 2, cancellationToken), cancellationToken);
